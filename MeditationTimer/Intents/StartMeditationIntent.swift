...
struct StartMeditationIntent: AppIntent {
    ...
    static var description: IntentDescription = "Begin a meditation session with MeditationTimer"
...
struct StartOpenEndedMeditationIntent: AppIntent {
    ...
    static var description: IntentDescription = "Begin a limitless stopwatch meditation session with MeditationTimer"
